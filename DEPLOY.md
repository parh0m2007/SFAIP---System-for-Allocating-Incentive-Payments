...
- Email-уведомления заместителю директора/учителю через Brevo (опционально)
...
- заместитель директора: `deputy@school101.local` / `demo1234`
...
5. `docker compose up -d server` — письма пойдут автоматически:
   - заместителю директора при отправке заявки учителем («Новая заявка на проверку»)
   - учителю при утверждении/отклонении (с суммой или комментарием заместителя директора)
